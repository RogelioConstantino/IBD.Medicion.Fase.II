<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRptGlobal.aspx.cs" Inherits="Medicion.frmRptGlobal" %>
...
<head runat="server">
    ...
    <script src="js_/jquery-1.12.4.js" type="text/javascript"></script>
...
<table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
	...
	<div class="col-xs-12 col-md-8">        
        <div id="Div1" class="table-responsive docs-table" runat="server"> 
            <table id="mytable" class="table table-bordred table-striped nowrap" 
                data-toggle="table" data-show-toggle="true" data-show-columns="true" 
                data-search="true" data-striped="true" data-show-export="true" 
